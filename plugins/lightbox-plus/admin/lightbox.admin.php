<?php
    ...
    * @version 2.5.5
    * @$Id: lightbox.admin.php 654094 2013-01-17 05:54:08Z dzappone $
    * @$URL: http://plugins.svn.wordpress.org/lightbox-plus/tags/2.5.5/admin/lightbox.admin.php $
    */
...
<div style="display:none">
    <div id="<?php echo $inline_hrefs[0]; ?>" style="padding: 10px;background: #fff">
        ...
        <h4><?php _e( 'Once again, you have my sincere thanks and appreciation for using <em>Lightbox Plus</em>.','lightboxplus' ); ?></h4>
        <div class="clear"></div>
    </div>
</div>
